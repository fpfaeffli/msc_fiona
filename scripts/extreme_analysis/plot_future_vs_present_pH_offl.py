...
for scenario in ['ssp245','ssp585']:
    for threshold_type in ['present','present_plus_meandelta']:#,]: #= 'present_plus_climdelta'
        ...
        for region_cho in ['coastal_all_lats']:#,'offshore_all_lats','coastal_northern','coastal_central','coastal_southern']:
            ...
            c10 = ax[1,0].pcolormesh(xedges[:-1], yedges[:-1], np.log10(hist2d.T/totnum*100), cmap=cmocean.cm.ice, vmin=-6, vmax=-1)
            ...
            savedir = '/nfs/sea/work/fpfaeffli/plots/future_vs_present/2D_heatmaps_anomalies/'
...
for region_cho in ['all_dists_all_lats']:
    for threshold_type in ['present','present_plus_meandelta']:#,'present_plus_climdelta']: #= 'present_plus_climdelta'
        ...
        savedir = '/nfs/sea/work/fpfaeffli/plots/future_vs_present/anomalies_rel_tresh/dist2coast_number_days/'
...
for region_cho in ['all_dists_all_lats']:
    for threshold_type in ['present','present_plus_meandelta']:#,'present_plus_climdelta']: #= 'present_plus_climdelta'
        ...
        savedir = '/nfs/sea/work/fpfaeffli/plots/future_vs_present/anomalies_rel_tresh/dist2coast_number_days/new_and_intensify_only/'
...
plt.tight_layout()
savedir = '/nfs/sea/work/fpfaeffli/plots/future_vs_present/onshore_vs_offshore/'
