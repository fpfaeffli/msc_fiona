...
plotted_values = Plotter.plot_full_map_annual_mean(var,dep,obs_da,model_da,obs_regions_dict,model_regions_dict,regional_data=[regional_data_obs,regional_data_model],regional_data_plottype='lines',savefig=False)
